package io.github.masyumero.morethermalevaporationcompat.extras.client.gui;
...
public class GuiInfiniteThermalEvaporationController extends GuiMekanismTile<TileEntityInfiniteThermalEvaporationController, MekanismTileContainer<TileEntityInfiniteThermalEvaporationController>> {

    public GuiInfiniteThermalEvaporationController(MekanismTileContainer<TileEntityInfiniteThermalEvaporationController> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 48, 19, 80, 40, () -> {
                    InfiniteThermalEvaporationMultiblockData multiblock = tile.getMultiblock();
...
//                .jeiCategory(tile) // TODO JEIのクラッシュを修正
        ...
        addRenderableWidget(new GuiHorizontalRateBar(this, new IBarInfoHandler() {
            ...
            public double getLevel() {
                return Math.min(1, tile.getMultiblock().getTemperature() / InfiniteThermalEvaporationMultiblockData.MAX_MULTIPLIER_TEMP);
            }
        }, 48, 63))
