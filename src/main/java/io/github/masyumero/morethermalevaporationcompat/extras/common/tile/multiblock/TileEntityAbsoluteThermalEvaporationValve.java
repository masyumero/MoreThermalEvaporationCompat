...
public class TileEntityAbsoluteThermalEvaporationValve extends TileEntityAbsoluteThermalEvaporationBlock {

    public TileEntityAbsoluteThermalEvaporationValve(BlockPos pos, BlockState state) {
        super(MoreThermalEvaporationCompatBlocks.ABSOLUTE_THERMAL_EVAPORATION_VALVE, pos, state);
    }
