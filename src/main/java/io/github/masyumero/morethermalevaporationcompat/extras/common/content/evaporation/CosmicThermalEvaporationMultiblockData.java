...
import io.github.masyumero.morethermalevaporationcompat.extras.common.tile.multiblock.TileEntityCosmicThermalEvaporationBlock;
...
public class CosmicThermalEvaporationMultiblockData extends MultiblockData implements IThermalEvaporationMultiblockData, IValveHandler, ISingleRecipeLookupHandler.FluidRecipeLookupHandler<FluidToFluidRecipe> {

    public static final int MAX_HEIGHT = 18;
    public static final double MAX_MULTIPLIER_TEMP = 384_000;
    ...
    public CosmicThermalEvaporationMultiblockData(TileEntityCosmicThermalEvaporationBlock tile) {
        super(tile);
        ...
        fluidTanks.add(outputTank = VariableCapacityFluidTank.output(this, () -> LoadConfig.MTE_COMPAT_CONFIG.getTankCapacity(AdvancedTier.COSMIC), BasicFluidTank.alwaysTrue, this));
    ...
    private static class RefreshListener implements NonNullConsumer<LazyOptional<IEvaporationSolar>> {
        private final WeakReference<CosmicThermalEvaporationMultiblockData> multiblock;
        private final int corner;

        private RefreshListener(CosmicThermalEvaporationMultiblockData multiblock, int corner) {
        ...
        public void accept(@NotNull LazyOptional<IEvaporationSolar> ignored) {
            CosmicThermalEvaporationMultiblockData multiblockData = multiblock.get();
