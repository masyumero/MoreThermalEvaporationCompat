...
public class InfiniteThermalEvaporationMultiblockData extends MultiblockData implements IThermalEvaporationMultiblockData, IValveHandler, ISingleRecipeLookupHandler.FluidRecipeLookupHandler<FluidToFluidRecipe> {
    ...
    public InfiniteThermalEvaporationMultiblockData(TileEntityInfiniteThermalEvaporationBlock tile) {
        ...
        fluidTanks.add(outputTank = VariableCapacityFluidTank.output(this, () -> LoadConfig.MTE_COMPAT_CONFIG.getTankCapacity(AdvancedTier.INFINITE), BasicFluidTank.alwaysTrue, this));
    ...
    private static class RefreshListener implements NonNullConsumer<LazyOptional<IEvaporationSolar>> {
        private final WeakReference<InfiniteThermalEvaporationMultiblockData> multiblock;
        private final int corner;

        private RefreshListener(InfiniteThermalEvaporationMultiblockData multiblock, int corner) {
        ...
        public void accept(@NotNull LazyOptional<IEvaporationSolar> ignored) {
            InfiniteThermalEvaporationMultiblockData multiblockData = multiblock.get();
