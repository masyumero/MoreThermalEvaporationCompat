...
import io.github.masyumero.morethermalevaporationcompat.extras.common.tile.multiblock.TileEntityAbsoluteThermalEvaporationBlock;
...
public class AbsoluteThermalEvaporationMultiblockData extends MultiblockData implements IThermalEvaporationMultiblockData, IValveHandler, ISingleRecipeLookupHandler.FluidRecipeLookupHandler<FluidToFluidRecipe> {
    ...
    public AbsoluteThermalEvaporationMultiblockData(TileEntityAbsoluteThermalEvaporationBlock tile) {
        super(tile);
        ...
        fluidTanks.add(outputTank = VariableCapacityFluidTank.output(this, () -> LoadConfig.MTE_COMPAT_CONFIG.getTankCapacity(AdvancedTier.ABSOLUTE), BasicFluidTank.alwaysTrue, this));
    ...
    private static class RefreshListener implements NonNullConsumer<LazyOptional<IEvaporationSolar>> {
        private final WeakReference<AbsoluteThermalEvaporationMultiblockData> multiblock;
        private final int corner;

        private RefreshListener(AbsoluteThermalEvaporationMultiblockData multiblock, int corner) {
        ...
        public void accept(@NotNull LazyOptional<IEvaporationSolar> ignored) {
            AbsoluteThermalEvaporationMultiblockData multiblockData = multiblock.get();
