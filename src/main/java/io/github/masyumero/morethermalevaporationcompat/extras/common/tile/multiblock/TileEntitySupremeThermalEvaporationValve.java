...
public class TileEntitySupremeThermalEvaporationValve extends TileEntitySupremeThermalEvaporationBlock {

    public TileEntitySupremeThermalEvaporationValve(BlockPos pos, BlockState state) {
        super(MoreThermalEvaporationCompatBlocks.SUPREME_THERMAL_EVAPORATION_VALVE, pos, state);
    }
