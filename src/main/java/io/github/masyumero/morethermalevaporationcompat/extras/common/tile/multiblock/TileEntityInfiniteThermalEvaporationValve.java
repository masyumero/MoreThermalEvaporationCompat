...
public class TileEntityInfiniteThermalEvaporationValve extends TileEntityInfiniteThermalEvaporationBlock {

    public TileEntityInfiniteThermalEvaporationValve(BlockPos pos, BlockState state) {
        super(MoreThermalEvaporationCompatBlocks.INFINITE_THERMAL_EVAPORATION_VALVE, pos, state);
    }
