...
public class TileEntityCosmicThermalEvaporationValve extends TileEntityCosmicThermalEvaporationBlock {

    public TileEntityCosmicThermalEvaporationValve(BlockPos pos, BlockState state) {
        super(MoreThermalEvaporationCompatBlocks.COSMIC_THERMAL_EVAPORATION_VALVE, pos, state);
    }
