...
public class RenderAbsoluteThermalEvaporationPlant extends MultiblockTileEntityRenderer<AbsoluteThermalEvaporationMultiblockData, TileEntityAbsoluteThermalEvaporationController> {

    public RenderAbsoluteThermalEvaporationPlant(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void render(TileEntityAbsoluteThermalEvaporationController tile, AbsoluteThermalEvaporationMultiblockData multiblock, float partialTick, PoseStack matrix, MultiBufferSource renderer,
    ...
    protected String getProfilerSection() {
        return "AbsoluteThermalEvaporationController";
    }
