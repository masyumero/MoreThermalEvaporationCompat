...
public class CompactRecipeProvider extends CompatRecipeProvider {
    ...
    private static void tieredController(Consumer<FinishedRecipe> consumer, String basePath) {
        for (TETier tier : MTECompatEnumUtils.THERMAL_EVAPORATION_TIERS) {
            switch (tier) {
                case ABSOLUTE -> ExtendedShapedRecipeBuilder.shapedRecipe(tier.getCompactBlock()).pattern(PATTERN).key(Pattern.PREVIOUS, tier.getControllerBlock()).key(Pattern.ALLOY, ExtraItems.RADIANCE_ALLOY).key(Pattern.CONSTANT, tier.getCasingBlock()).build(consumer, MoreThermalEvaporationCompat.rl(basePath + tier.getLowerName() + "/compact"));
                case SUPREME -> ExtendedShapedRecipeBuilder.shapedRecipe(tier.getCompactBlock()).pattern(PATTERN).key(Pattern.PREVIOUS, tier.getControllerBlock()).key(Pattern.ALLOY, ExtraItems.THERMONUCLEAR_ALLOY).key(Pattern.CONSTANT, tier.getCasingBlock()).build(consumer, MoreThermalEvaporationCompat.rl(basePath + tier.getLowerName() + "/compact"));
                case COSMIC -> ExtendedShapedRecipeBuilder.shapedRecipe(tier.getCompactBlock()).pattern(PATTERN).key(Pattern.PREVIOUS, tier.getControllerBlock()).key(Pattern.ALLOY, ExtraItems.SHINING_ALLOY).key(Pattern.CONSTANT, tier.getCasingBlock()).build(consumer, MoreThermalEvaporationCompat.rl(basePath + tier.getLowerName() + "/compact"));
                case INFINITE -> ExtendedShapedRecipeBuilder.shapedRecipe(tier.getCompactBlock()).pattern(PATTERN).key(Pattern.PREVIOUS, tier.getControllerBlock()).key(Pattern.ALLOY, ExtraItems.SPECTRUM_ALLOY).key(Pattern.CONSTANT, tier.getCasingBlock()).build(consumer, MoreThermalEvaporationCompat.rl(basePath + tier.getLowerName() + "/compact"));
                ...
                case ABSOLUTE_OVERCLOCKED -> ExtendedShapedRecipeBuilder.shapedRecipe(tier.getCompactBlock()).pattern(EMEXTRA_PATTERN).key(Pattern.PREVIOUS, tier.getControllerBlock()).key(Pattern.ALLOY, ExtraItems.RADIANCE_ALLOY).key(Pattern.ALLOY1, EMItems.HYPERCHARGED_ALLOY).key(Pattern.CONSTANT, tier.getCasingBlock()).build(consumer, MoreThermalEvaporationCompat.rl(basePath + tier.getLowerName() + "/compact"));
                case SUPREME_QUANTUM -> ExtendedShapedRecipeBuilder.shapedRecipe(tier.getCompactBlock()).pattern(EMEXTRA_PATTERN).key(Pattern.PREVIOUS, tier.getControllerBlock()).key(Pattern.ALLOY, ExtraItems.THERMONUCLEAR_ALLOY).key(Pattern.ALLOY1, EMItems.SUBATOMIC_ALLOY).key(Pattern.CONSTANT, tier.getCasingBlock()).build(consumer, MoreThermalEvaporationCompat.rl(basePath + tier.getLowerName() + "/compact"));
                case COSMIC_DENSE -> ExtendedShapedRecipeBuilder.shapedRecipe(tier.getCompactBlock()).pattern(EMEXTRA_PATTERN).key(Pattern.PREVIOUS, tier.getControllerBlock()).key(Pattern.ALLOY, ExtraItems.SHINING_ALLOY).key(Pattern.ALLOY1, EMItems.SINGULAR_ALLOY).key(Pattern.CONSTANT, tier.getCasingBlock()).build(consumer, MoreThermalEvaporationCompat.rl(basePath + tier.getLowerName() + "/compact"));
                case INFINITE_MULTIVERSAL -> ExtendedShapedRecipeBuilder.shapedRecipe(tier.getCompactBlock()).pattern(EMEXTRA_PATTERN).key(Pattern.PREVIOUS, tier.getControllerBlock()).key(Pattern.ALLOY, ExtraItems.SPECTRUM_ALLOY).key(Pattern.ALLOY1, EMItems.EXOVERSAL_ALLOY).key(Pattern.CONSTANT, tier.getCasingBlock()).build(consumer, MoreThermalEvaporationCompat.rl(basePath + tier.getLowerName() + "/compact"));
            }
        }
    }
}
