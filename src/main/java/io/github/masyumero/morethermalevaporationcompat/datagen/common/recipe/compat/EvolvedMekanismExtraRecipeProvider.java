...
public class EvolvedMekanismExtraRecipeProvider extends CompatRecipeProvider{
    ...
    private static void tieredBlock(Consumer<FinishedRecipe> consumer, String basePath) {
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.ABSOLUTE_OVERCLOCKED), 4).pattern(BLOCK_PATTERN).key(Pattern.ALLOY, ExtraItems.RADIANCE_ALLOY).key(Pattern.ALLOY1, EMItems.HYPERCHARGED_ALLOY).key(Pattern.CIRCUIT, EMExtrasItem.ABSOLUTE_OVERCLOCKED_CONTROL_CIRCUIT).key(Pattern.CONSTANT, MoreThermalEvaporationBlocks.BLOCKS.get(MoreThermalEvaporationTier.ULTIMATE)).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "absolute_overclocked/block"));
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.SUPREME_QUANTUM), 4).pattern(BLOCK_PATTERN).key(Pattern.ALLOY, ExtraItems.THERMONUCLEAR_ALLOY).key(Pattern.ALLOY1, EMItems.SUBATOMIC_ALLOY).key(Pattern.CIRCUIT, EMExtrasItem.SUPREME_QUANTUM_CONTROL_CIRCUIT).key(Pattern.CONSTANT, MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.ABSOLUTE_OVERCLOCKED)).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "supreme_quantum/block"));
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.COSMIC_DENSE), 4).pattern(BLOCK_PATTERN).key(Pattern.ALLOY, ExtraItems.SHINING_ALLOY).key(Pattern.ALLOY1, EMItems.SINGULAR_ALLOY).key(Pattern.CIRCUIT, EMExtrasItem.COSMIC_DENSE_CONTROL_CIRCUIT).key(Pattern.CONSTANT, MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.SUPREME_QUANTUM)).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "cosmic_dense/block"));
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.INFINITE_MULTIVERSAL), 4).pattern(BLOCK_PATTERN).key(Pattern.ALLOY, ExtraItems.SPECTRUM_ALLOY).key(Pattern.ALLOY1, EMItems.EXOVERSAL_ALLOY).key(Pattern.CIRCUIT, EMExtrasItem.INFINITE_MULTIVERSAL_CONTROL_CIRCUIT).key(Pattern.CONSTANT, MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.COSMIC_DENSE)).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "infinite_multiversal/block"));
    }

    private static void tieredController(Consumer<FinishedRecipe> consumer, String basePath) {
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationCompatBlocks.getControllerBlock(TETier.ABSOLUTE_OVERCLOCKED)).controllerPattern().key(Pattern.CIRCUIT, EMExtrasItem.ABSOLUTE_OVERCLOCKED_CONTROL_CIRCUIT).key(Pattern.OTHER, MoreThermalEvaporationBlocks.CONTROLLERS.get(MoreThermalEvaporationTier.ULTIMATE)).key(Pattern.CONSTANT, MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.ABSOLUTE_OVERCLOCKED)).key(MTECompatRecipeProvider.GLASS_CHAR, Tags.Items.GLASS_PANES).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "absolute_overclocked/controller"));
    ...
    private static void tieredValve(Consumer<FinishedRecipe> consumer, String basePath) {
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationCompatBlocks.getValveBlock(TETier.ABSOLUTE_OVERCLOCKED)).valvePattern().key(Pattern.CONSTANT, MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.ABSOLUTE_OVERCLOCKED)).key(Pattern.OTHER, MoreThermalEvaporationBlocks.VALVES.get(MoreThermalEvaporationTier.ULTIMATE)).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "absolute_overclocked/valve"));
