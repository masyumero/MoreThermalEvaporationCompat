...
public class EvolvedMekanismRecipeProvider extends CompatRecipeProvider {
    ...
    private static void tieredController(Consumer<FinishedRecipe> consumer, String basePath) {
        ...
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationBlocks.getController(MoreThermalEvaporationTier.CREATIVE)).controllerPattern().key(Pattern.CIRCUIT, EMItems.CREATIVE_CONTROL_CIRCUIT).key(Pattern.OTHER, MoreThermalEvaporationCompatBlocks.getControllerBlock(TETier.MULTIVERSAL)).key(Pattern.CONSTANT, MoreThermalEvaporationBlocks.getBlock(MoreThermalEvaporationTier.CREATIVE)).key(MTECompatRecipeProvider.GLASS_CHAR, Tags.Items.GLASS_PANES).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "creative/controller"));
    }
    ...
    private static void tieredValve(Consumer<FinishedRecipe> consumer, String basePath) {
        ...
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationBlocks.getValve(MoreThermalEvaporationTier.CREATIVE)).valvePattern().key(Pattern.CONSTANT, MoreThermalEvaporationBlocks.getBlock(MoreThermalEvaporationTier.CREATIVE)).key(Pattern.OTHER, MoreThermalEvaporationCompatBlocks.getValveBlock(TETier.MULTIVERSAL)).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "creative/valve"));
    }
}
