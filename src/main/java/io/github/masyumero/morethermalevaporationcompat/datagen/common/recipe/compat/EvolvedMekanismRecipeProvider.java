...
public class EvolvedMekanismRecipeProvider extends CompatRecipeProvider {
    ...
    private static void tieredBlock(Consumer<FinishedRecipe> consumer, String basePath) {
        ...
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationBlocks.BLOCKS.get(MoreThermalEvaporationTier.CREATIVE), 4).blockPattern().key(Pattern.ALLOY, EMItems.CREATIVE_ALLOY).key(Pattern.CIRCUIT, EMItems.CREATIVE_CONTROL_CIRCUIT).key(Pattern.CONSTANT, MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.MULTIVERSAL)).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "creative/block"));
    }

    private static void tieredController(Consumer<FinishedRecipe> consumer, String basePath) {
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationCompatBlocks.getControllerBlock(TETier.OVERCLOCKED)).controllerPattern().key(Pattern.CIRCUIT, EMItems.OVERCLOCKED_CONTROL_CIRCUIT).key(Pattern.OTHER, MoreThermalEvaporationBlocks.CONTROLLERS.get(MoreThermalEvaporationTier.ULTIMATE)).key(Pattern.CONSTANT, MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.OVERCLOCKED)).key(MTECompatRecipeProvider.GLASS_CHAR, Tags.Items.GLASS_PANES).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "overclocked/controller"));
        ...
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationBlocks.CONTROLLERS.get(MoreThermalEvaporationTier.CREATIVE)).controllerPattern().key(Pattern.CIRCUIT, EMItems.CREATIVE_CONTROL_CIRCUIT).key(Pattern.OTHER, MoreThermalEvaporationCompatBlocks.getControllerBlock(TETier.MULTIVERSAL)).key(Pattern.CONSTANT, MoreThermalEvaporationBlocks.BLOCKS.get(MoreThermalEvaporationTier.CREATIVE)).key(MTECompatRecipeProvider.GLASS_CHAR, Tags.Items.GLASS_PANES).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "creative/controller"));
    }

    private static void tieredValve(Consumer<FinishedRecipe> consumer, String basePath) {
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationCompatBlocks.getValveBlock(TETier.OVERCLOCKED)).valvePattern().key(Pattern.CONSTANT, MoreThermalEvaporationCompatBlocks.getCasingBlock(TETier.OVERCLOCKED)).key(Pattern.OTHER, MoreThermalEvaporationBlocks.VALVES.get(MoreThermalEvaporationTier.ULTIMATE)).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "overclocked/valve"));
        ...
        ExtendedShapedRecipeBuilder.shapedRecipe(MoreThermalEvaporationBlocks.VALVES.get(MoreThermalEvaporationTier.CREATIVE)).valvePattern().key(Pattern.CONSTANT, MoreThermalEvaporationBlocks.BLOCKS.get(MoreThermalEvaporationTier.CREATIVE)).key(Pattern.OTHER, MoreThermalEvaporationCompatBlocks.getValveBlock(TETier.MULTIVERSAL)).build(consumer, MoreThermalEvaporationCompat.rl(basePath+ "creative/valve"));
    }
}
