...
@Mixin(value = TileEntityBasicThermalEvaporationController.class, remap = false)
public abstract class MixinTileEntityBasicThermalEvaporationController extends TileEntityBasicThermalEvaporationBlock {

    public MixinTileEntityBasicThermalEvaporationController(BlockPos pos, BlockState state) {
        super(pos, state);
    }
