...
@Mixin(value = BasicThermalEvaporationMultiblockData.class, remap = false)
public abstract class MixinBasicThermalEvaporationMultiblockData implements IThermalEvaporationMultiblockData {
