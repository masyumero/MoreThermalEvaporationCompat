...
@Mixin(value = EliteThermalEvaporationMultiblockData.class, remap = false)
public abstract class MixinEliteThermalEvaporationMultiblockData implements IThermalEvaporationMultiblockData {
