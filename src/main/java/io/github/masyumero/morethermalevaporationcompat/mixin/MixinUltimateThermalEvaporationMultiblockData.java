...
@Mixin(value = UltimateThermalEvaporationMultiblockData.class, remap = false)
public abstract class MixinUltimateThermalEvaporationMultiblockData implements IThermalEvaporationMultiblockData {
    ...
    private double simulateEnvironmentModify(double par1) {
        ...
        return getActiveSolars() * mteCompat$upgradeCount * MekanismConfig.general.evaporationSolarMultiplier.get() * heatCapacity;
    }
}
