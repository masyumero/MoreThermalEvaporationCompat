...
@Mixin(value = TileEntityAdvancedThermalEvaporationController.class, remap = false)
public abstract class MixinTileEntityAdvancedThermalEvaporationController extends TileEntityAdvancedThermalEvaporationBlock {
    public MixinTileEntityAdvancedThermalEvaporationController(BlockPos pos, BlockState state) {
        super(pos, state);
    }
