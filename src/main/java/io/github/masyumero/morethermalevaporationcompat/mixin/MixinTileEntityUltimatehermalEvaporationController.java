...
@Mixin(value = TileEntityUltimateThermalEvaporationController.class, remap = false)
public abstract class MixinTileEntityUltimatehermalEvaporationController extends TileEntityUltimateThermalEvaporationBlock {

    public MixinTileEntityUltimatehermalEvaporationController(BlockPos pos, BlockState state) {
        super(pos, state);
    }
