...
public class TileEntityTieredThermalEvaporationValve extends TileEntityTieredThermalEvaporationBlock {

    public TileEntityTieredThermalEvaporationValve(BlockPos pos, BlockState state, TETier tier) {
        super(tier.getValveBlock(), pos, state);
    }
