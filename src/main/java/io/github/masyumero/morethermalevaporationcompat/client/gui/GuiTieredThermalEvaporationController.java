...
public class GuiTieredThermalEvaporationController extends GuiMekanismTile<TileEntityTieredThermalEvaporationController, MekanismTileContainer<TileEntityTieredThermalEvaporationController>> {

    private final TETier tier;

    public GuiTieredThermalEvaporationController(MekanismTileContainer<TileEntityTieredThermalEvaporationController> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 48, 19, 80, 40, () -> {
                    TieredThermalEvaporationMultiblockData multiblock = tile.getMultiblock();
        ...
        addRenderableWidget(new GuiHorizontalRateBar(this, new IBarInfoHandler() {
            ...
            public double getLevel() {
                return Math.min(1, tile.getMultiblock().getTemperature() / tier.getMaxMultiplierTemp());
            }
        }, 48, 63))
