...
public class TileEntityQuantumThermalEvaporationValve extends TileEntityQuantumThermalEvaporationBlock {

    public TileEntityQuantumThermalEvaporationValve(BlockPos pos, BlockState state) {
        super(MoreThermalEvaporationCompatBlocks.QUANTUM_THERMAL_EVAPORATION_VALVE, pos, state);
    }
