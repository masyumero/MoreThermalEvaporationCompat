package io.github.masyumero.morethermalevaporationcompat.evolved.client.gui;
...
public class GuiMultiversalThermalEvaporationController extends GuiMekanismTile<TileEntityMultiversalThermalEvaporationController, MekanismTileContainer<TileEntityMultiversalThermalEvaporationController>> {

    public GuiMultiversalThermalEvaporationController(MekanismTileContainer<TileEntityMultiversalThermalEvaporationController> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 48, 19, 80, 40, () -> {
                    MultiversalThermalEvaporationMultiblockData multiblock = tile.getMultiblock();
...
//                .jeiCategory(tile) // TODO JEIのクラッシュを修正
        ...
        addRenderableWidget(new GuiHorizontalRateBar(this, new IBarInfoHandler() {
            ...
            public double getLevel() {
                return Math.min(1, tile.getMultiblock().getTemperature() / MultiversalThermalEvaporationMultiblockData.MAX_MULTIPLIER_TEMP);
            }
        }, 48, 63))
