...
public class TileEntityMultiversalThermalEvaporationValve extends TileEntityMultiversalThermalEvaporationBlock {

    public TileEntityMultiversalThermalEvaporationValve(BlockPos pos, BlockState state) {
        super(MoreThermalEvaporationCompatBlocks.MULTIVERSAL_THERMAL_EVAPORATION_VALVE, pos, state);
    }
