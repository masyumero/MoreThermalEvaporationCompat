...
import io.github.masyumero.morethermalevaporationcompat.evolved.common.tile.multiblock.TileEntityOverclockedThermalEvaporationBlock;
...
public class OverclockedThermalEvaporationMultiblockData extends MultiblockData implements IThermalEvaporationMultiblockData, IValveHandler, ISingleRecipeLookupHandler.FluidRecipeLookupHandler<FluidToFluidRecipe> {

    public static final int MAX_HEIGHT = 18;
    public static final double MAX_MULTIPLIER_TEMP = 96_000;
    ...
    public OverclockedThermalEvaporationMultiblockData(TileEntityOverclockedThermalEvaporationBlock tile) {
        super(tile);
        ...
        fluidTanks.add(outputTank = VariableCapacityFluidTank.output(this, () -> LoadConfig.MTE_COMPAT_CONFIG.getTankCapacity(EMBaseTier.DENSE), BasicFluidTank.alwaysTrue, this));
    ...
    private static class RefreshListener implements NonNullConsumer<LazyOptional<IEvaporationSolar>> {
        private final WeakReference<OverclockedThermalEvaporationMultiblockData> multiblock;
        private final int corner;

        private RefreshListener(OverclockedThermalEvaporationMultiblockData multiblock, int corner) {
        ...
        public void accept(@NotNull LazyOptional<IEvaporationSolar> ignored) {
            OverclockedThermalEvaporationMultiblockData multiblockData = multiblock.get();
