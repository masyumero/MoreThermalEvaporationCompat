...
public class RenderQuantumThermalEvaporationPlant extends MultiblockTileEntityRenderer<QuantumThermalEvaporationMultiblockData, TileEntityQuantumThermalEvaporationController> {

    public RenderQuantumThermalEvaporationPlant(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void render(TileEntityQuantumThermalEvaporationController tile, QuantumThermalEvaporationMultiblockData multiblock, float partialTick, PoseStack matrix, MultiBufferSource renderer,
    ...
    protected String getProfilerSection() {
        return "QuantumThermalEvaporationController";
    }

    @Override
    protected boolean shouldRender(TileEntityQuantumThermalEvaporationController tile, QuantumThermalEvaporationMultiblockData multiblock, Vec3 camera) {
