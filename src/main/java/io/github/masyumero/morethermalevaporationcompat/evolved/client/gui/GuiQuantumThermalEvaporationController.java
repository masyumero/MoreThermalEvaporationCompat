...
public class GuiQuantumThermalEvaporationController extends GuiMekanismTile<TileEntityQuantumThermalEvaporationController, MekanismTileContainer<TileEntityQuantumThermalEvaporationController>> {

    public GuiQuantumThermalEvaporationController(MekanismTileContainer<TileEntityQuantumThermalEvaporationController> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 48, 19, 80, 40, () -> {
                    QuantumThermalEvaporationMultiblockData multiblock = tile.getMultiblock();
...
//                .jeiCategory(tile) // TODO JEIのクラッシュを修正
        ...
        addRenderableWidget(new GuiHorizontalRateBar(this, new IBarInfoHandler() {
            ...
            public double getLevel() {
                return Math.min(1, tile.getMultiblock().getTemperature() / QuantumThermalEvaporationMultiblockData.MAX_MULTIPLIER_TEMP);
            }
        }, 48, 63))
