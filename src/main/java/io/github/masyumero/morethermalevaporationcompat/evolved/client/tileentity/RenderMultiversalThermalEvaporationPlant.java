...
public class RenderMultiversalThermalEvaporationPlant extends MultiblockTileEntityRenderer<MultiversalThermalEvaporationMultiblockData, TileEntityMultiversalThermalEvaporationController> {

    public RenderMultiversalThermalEvaporationPlant(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void render(TileEntityMultiversalThermalEvaporationController tile, MultiversalThermalEvaporationMultiblockData multiblock, float partialTick, PoseStack matrix, MultiBufferSource renderer,
    ...
    protected String getProfilerSection() {
        return "MultiversalThermalEvaporationController";
    }

    @Override
    protected boolean shouldRender(TileEntityMultiversalThermalEvaporationController tile, MultiversalThermalEvaporationMultiblockData multiblock, Vec3 camera) {
