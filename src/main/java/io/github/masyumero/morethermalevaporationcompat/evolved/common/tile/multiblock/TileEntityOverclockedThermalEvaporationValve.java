...
public class TileEntityOverclockedThermalEvaporationValve extends TileEntityOverclockedThermalEvaporationBlock {

    public TileEntityOverclockedThermalEvaporationValve(BlockPos pos, BlockState state) {
        super(MoreThermalEvaporationCompatBlocks.OVERCLOCKED_THERMAL_EVAPORATION_VALVE, pos, state);
    }
