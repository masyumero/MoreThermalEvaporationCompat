...
import io.github.masyumero.morethermalevaporationcompat.evolved.common.tile.multiblock.TileEntityDenseThermalEvaporationBlock;
...
public class DenseThermalEvaporationMultiblockData extends MultiblockData implements IThermalEvaporationMultiblockData, IValveHandler, ISingleRecipeLookupHandler.FluidRecipeLookupHandler<FluidToFluidRecipe> {
    ...
    public DenseThermalEvaporationMultiblockData(TileEntityDenseThermalEvaporationBlock tile) {
        super(tile);
        ...
        fluidTanks.add(outputTank = VariableCapacityFluidTank.output(this, () -> LoadConfig.MTE_COMPAT_CONFIG.getTankCapacity(EMBaseTier.OVERCLOCKED), BasicFluidTank.alwaysTrue, this));
    ...
    private static class RefreshListener implements NonNullConsumer<LazyOptional<IEvaporationSolar>> {
        private final WeakReference<DenseThermalEvaporationMultiblockData> multiblock;
        private final int corner;

        private RefreshListener(DenseThermalEvaporationMultiblockData multiblock, int corner) {
        ...
        public void accept(@NotNull LazyOptional<IEvaporationSolar> ignored) {
            DenseThermalEvaporationMultiblockData multiblockData = multiblock.get();
