...
public class TileEntityDenseThermalEvaporationValve extends TileEntityDenseThermalEvaporationBlock {

    public TileEntityDenseThermalEvaporationValve(BlockPos pos, BlockState state) {
        super(MoreThermalEvaporationCompatBlocks.DENSE_THERMAL_EVAPORATION_VALVE, pos, state);
    }
